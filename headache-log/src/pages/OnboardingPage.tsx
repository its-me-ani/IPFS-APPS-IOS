                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            ...
                            <div className="step-header">
                                ...
                                <p className="step-subtitle">Track headache frequency, symptoms, pain scale, and medication offline.</p>
                            </div>
                                ...
                                <div className="onboarding-welcome">
                                    <div className="welcome-features">
                                        <div className="feature-item">
                                            ...
                                            <span>Log headache start time, duration, and pain scale levels easily</span>
                                        </div>
                                        <div className="feature-item">
                                            <IonIcon icon={checkmarkCircle} color="success" />
                                            <span>Track associated symptoms, activities, food/water intake, and triggers</span>
                                        </div>
                                        <div className="feature-item">
                                            <IonIcon icon={checkmarkCircle} color="success" />
                                            <span>Maintain detailed medication logs and export comprehensive health reports</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
